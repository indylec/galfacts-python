...
#(divide out beam &) account for size of array:
    ...
    e=Circle((512,512),radius=100)
    f=Circle((512,512),radius=24)
    g=Circle((512,512),radius=48)
    h=Circle((512,512),radius=190)
    ...
    circ1=str(int(ell_r[512,536]))
    circ2=str(int(ell_r[512,560]))
    circ3=str(int(ell_r[512,612]))
    circ4=str(int(ell_r[512,702]))

    e1=Circle((512,512),radius=100)
    f1=Circle((512,512),radius=24)
    g1=Circle((512,512),radius=48)
    h1=Circle((512,512),radius=190)
    ...
    e2=Circle((512,512),radius=100)
    f2=Circle((512,512),radius=24)
    g2=Circle((512,512),radius=48)
    h2=Circle((512,512),radius=190)
    ...
    e3=Circle((512,512),radius=100)
    f3=Circle((512,512),radius=24)
    g3=Circle((512,512),radius=48)
    h3=Circle((512,512),radius=190)
    ...
    im1=ax1.imshow(np.log(np.abs(qft_final)))
    cbar1=plt.colorbar(mappable=im1, ax=ax1)
    cbar1.set_label('$\mathrm{log}_{10} \; C_{\ell} [\mathrm{K}^2]$',size=12)
    cbar1.ax.tick_params(labelsize=7)

    ax1.text(32,212,'circles at $\ell$ = '+circ1+', '+circ2+', '+circ3+', '+circ4,fontsize=8)
    ax1.text(32,950,'Q')
    ...
    im2=ax2.imshow(np.log(np.abs(uft_final)))
    cbar2=plt.colorbar(mappable=im2, ax=ax2)
    cbar2.set_label('$\mathrm{log}_{10} \; C_{\ell} [\mathrm{K}^2]$',size=12)
    cbar2.ax.tick_params(labelsize=7)

    ax2.text(32,212,'circles at $\ell$ = '+circ1+', '+circ2+', '+circ3+', '+circ4,fontsize=8)
    ax2.text(32,950,'U')
    ...
    im3=ax3.imshow(np.log(np.abs(ee_scaled)))
    cbar3=plt.colorbar(mappable=im3, ax=ax3)
    cbar3.set_label('$\mathrm{log}_{10} \; C_{\ell} [\mathrm{K}^2]$',size=12)
    cbar3.ax.tick_params(labelsize=7)
    
    ax3.text(32,212,'circles at $\ell$ = '+circ1+', '+circ2+', '+circ3+', '+circ4,fontsize=8)
    ax3.text(32,950,'EE')
    ...
    im4=ax4.imshow(np.log(np.abs(ee_scaled)))
    ...
    ax4.text(32,212,'circles at $\ell$ = '+circ1+', '+circ2+', '+circ3+', '+circ4,fontsize=8)
    ax4.text(32,950,'BB')
    ...
    plt.savefig('s1_'+str(i)+'_2dft_withcirc.png',dpi=200)
