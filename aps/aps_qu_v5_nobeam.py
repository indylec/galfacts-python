...
#Plot the APS on the left hand side of the figure
    ...
    ax.legend([(ee_mark),(bb_mark),beam_cut],["EE","BB","beamwidth scale"],fontsize='medium')
    ax.set_xscale('log') 
    ax.set_yscale('log')



    fig.savefig("/Users/leclercq/galfacts/aps/plots/v5.1/"+field+"_apsv5.1_nobeam_dqa3.1.2_c"+str(i)+".pdf",dpi=200)
