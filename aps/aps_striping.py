...
#taper, pad
    ...
    tt_average[nonzero_tt]=area1024*tt_hist[nonzero_tt]/ell_hist[nonzero_tt]
...
#Plot the APS on the left hand side of the figure
    ...
    ax.plot(bins_axis,tt_average,'bx',label='TT')
    ...
    fig.savefig("/Users/leclercq/galfacts/aps/plots/v3/"+field+"_aps_stripes_dqa3.2_c"+str(i)+".pdf",dpi=100)
