...
newqhdu.writeto('S1_q_inpaint_final.fits')

#Work on U now
#filter relevant rows
utbdata4=tbdata[np.abs(tbdata['Peak_2'])>4.0*np.abs(tbdata['rms_2'])]
utbdata3=tbdata[np.logical_and(4.0*np.abs(tbdata['rms_2'])>np.abs(tbdata['Peak_2']),np.abs(tbdata['Peak_2'])>3.0*np.abs(tbdata['rms_2']))]
utbdata2=tbdata[np.logical_and(3.0*np.abs(tbdata['rms_2'])>np.abs(tbdata['Peak_2']),np.abs(tbdata['Peak_2'])>2.0*np.abs(tbdata['rms_2']))]
utbdata1=tbdata[np.logical_and(2.0*np.abs(tbdata['rms_2'])>np.abs(tbdata['Peak_2']),np.abs(tbdata['Peak_2'])>1.0*np.abs(tbdata['rms_2']))]
...
newuhdu.writeto('S1_u_inpaint_final.fits')
